...
declare
type
ASTIfCondition = {exp: ? string; block: ASTElement};
declare
type
...
ASTElementHandler | Array < ASTElementHandler >;
}
;
...
declare
type
ASTNode = ASTElement | ASTText | ASTExpression;
